      ...
      <div className="mb-6">
        <table className="w-full border-collapse border border-gray-300">
          ...
          <tbody>
            ...
            {discount && discount > 0 && (
              <tr>
                <td colSpan={5} className="border border-gray-300 p-2 text-right font-semibold">Chiết khấu:</td>
                <td className="border border-gray-300 p-2 text-right">{discount.toLocaleString()}</td>
              </tr>
            )}
            <tr className="bg-gray-100 font-bold">
              <td colSpan={5} className="border border-gray-300 p-2 text-right">Phải thanh toán:</td>
