...
export default function QuotationTemplate({
  ...
  const printToPdf = async () => {
    ...
    try {
      ...
      pdf.setFontSize(18);
      pdf.setFont('helvetica', 'bold');
      pdf.text('BÁO GIÁ DỊCH VỤ', pageWidth / 2, yPosition + 35, { align: 'center' });
      ...
      // Customer info table with dark styling
      pdf.autoTable({
        startY: yPosition,
        body: [
      ...
      yPosition += 6;
      pdf.text('- Báo giá có giá trị trong vòng 7 ngày kể từ ngày 06/06/2025.', margin, yPosition);
      ...
      pdf.setFontSize(10);
      pdf.setFont('helvetica', 'bold');
      pdf.text('Người lập báo giá', pageWidth - margin - 50, yPosition, { align: 'center' });
      yPosition += 6;
      pdf.setFont('helvetica', 'normal');
    ...
    <div className="max-w-4xl mx-auto p-6 bg-white">
      ...
      <div className="flex items-start justify-between mb-8">
        ...
        <div className="text-right">
          <h2 className="text-2xl font-bold text-blue-600 mb-2">BÁO GIÁ DỊCH VỤ</h2>
      ...
      <div className="mb-6">
        ...
        {(() => {
          ...
          return materials.length > 0 ? (
            <div className="mb-6">
              <h3 className="text-lg font-bold mb-3">Chi tiết vật tư</h3>
              <table className="w-full border-collapse border border-gray-300">
                <thead>
                  <tr className="bg-gray-800 text-white">
                    <th className="border border-gray-300 p-2 text-center">STT</th>
                    <th className="border border-gray-300 p-2 text-left">Tên vật tư</th>
                ...
                <tbody>
                  ...
                  <tr className="bg-gray-800 text-white font-bold">
                    ...
                    <td className="border border-gray-300 p-2">Cộng vật tư:</td>
                    <td className="border border-gray-300 p-2"></td>
                    <td className="border border-gray-300 p-2"></td>
                    <td className="border border-gray-300 p-2"></td>
