...
export default function QuotationTemplate({
  ...
  const printToPdf = async () => {
    ...
    try {
      ...
      pdf.setFontSize(20);
      pdf.setFont('helvetica', 'bold');
      pdf.text('BÁO GIÁ DỊCH VỤ', pageWidth - margin - 60, margin + 10);
      
      pdf.setFontSize(12);
      pdf.setFont('helvetica', 'normal');
      pdf.text(`Số: ${invoiceNumber}`, pageWidth - margin - 60, margin + 20);
      pdf.text(`Ngày: ${formatLocalDate(invoiceDate)}`, pageWidth - margin - 60, margin + 28);
      yPosition += 15;
    ...
    <div className="bg-white max-w-4xl mx-auto p-6 shadow-md">
      <div className="flex justify-between mb-8 border-b-2 pb-6">
        ...
        <div className="text-right flex-shrink-0 ml-8">
          <h2 className="text-2xl font-bold mb-4 text-blue-600">BÁO GIÁ DỊCH VỤ</h2>
